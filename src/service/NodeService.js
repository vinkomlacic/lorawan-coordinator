...
/**
 * Fetches all nodes.
 * @param {bool} [active=false] returns only active nodes if true
 * @param {bool} [passive=false] returns only passive nodes if true
 * @async
 */
 ...
 * @param {bool} [active=false] prints only active nodes if true
 * @param {bool} [passive=false] prints only passive nodes if true
